...
# Builder Design pattern kullanarak kredi kartı oluşturacağız.
...
class AmericanExpressCard(CreditCardBuilder):
    def __init__(self):
        super().__init__()
        self._credit_card = super().credit_card # Burada fonksiyonu çağırdık.
    ...
    def card_type_func(self) -> str:
        self._credit_card.card_type = 'America Express'
...
# OCP , LSP , DI ,IoC prensiplerini araştırın.